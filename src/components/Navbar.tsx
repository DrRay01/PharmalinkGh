        ...
        {currentUser.role === 'patient' && (
          <div className="hidden lg:flex items-center gap-2">
            <div className="relative group">
              <button className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-slate-100/80 hover:bg-slate-200/80 text-xs font-semibold text-slate-700 transition-colors border border-slate-200/60">
              ...
              {/* Dropdown Menu */}
              <div className="absolute left-0 mt-1.5 w-72 bg-white rounded-md shadow-xl border border-slate-200 py-2 hidden group-hover:block z-50">
        ...
        <nav className="flex items-center gap-1 sm:gap-2">
            ...
            <>
              ...
              {!isGuest && (
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-xs font-bold transition-all relative flex items-center gap-1.5 ${
                ...
                >
                  ...
                  {activeReservationsCount > 0 && (
                    <span className="bg-emerald-500 text-white text-[10px] font-mono font-bold px-1.5 py-0.2 rounded-md">
                      {activeReservationsCount}
                    </span>
                  )}
                </button>
          ...
          {currentUser.role === 'pharmacist' && (
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center gap-1 text-xs font-bold text-emerald-800 bg-emerald-50 px-3 py-1.5 rounded-md border border-emerald-200/80">
          ...
          {currentUser.role === 'admin' && (
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center gap-1 text-xs font-bold text-amber-800 bg-amber-50 px-3 py-1.5 rounded-md border border-amber-200/80">
          ...
          {isGuest ? (
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="px-3.5 py-1.5 rounded-md border border-slate-200 hover:border-slate-300 hover:bg-slate-50 text-xs font-bold text-slate-700 transition-colors shadow-2xs"
              >
                Sign In
              </button>
              <button
                ...
                className="hidden sm:inline-flex items-center gap-1 px-3.5 py-1.5 rounded-md bg-slate-950 hover:bg-slate-800 text-white text-xs font-bold transition-colors shadow-xs"
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 p-1 pl-2 rounded-md hover:bg-slate-100 transition-colors border border-slate-200"
                >
                ...
                {isUserMenuOpen && (
                  <div 
                    className="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-xl border border-slate-200 py-3 z-50 animate-in fade-in slide-in-from-top-2 duration-150"
